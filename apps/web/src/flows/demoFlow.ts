...
export const demoFlow: StepDef[] = [
  ...
  },
  {
    ...
    path: '/transactions',
    title: 'Credit +$100.00',
    description: 'We credit Alice\'s account with $100.00 (10,000 cents).',
  ...
  },
  {
    ...
    path: '/transactions',
    title: 'Credit +$50.00',
    description: 'We credit another $50.00. Alice now has $150.00.',
  ...
  },
  {
    ...
    method: 'POST',
    path: '/transactions',
    title: 'Debit -$30.00 with idempotency',
    description: 'We debit $30.00, including an Idempotency-Key header.',
  ...
  },
  {
    ...
    whyItMatters: 'The server returns the cached response — no new debit occurs. Balance stays at $120.00.',
    getBody: () => ({ type: 'DEBIT', amount: 3000 }),
    getHeaders: (ctx) => ({
      Authorization: `Bearer ${ctx.token ?? ''}`,
      'Idempotency-Key': 'demo-debit-001',
  ...
  },
  {
    ...
    path: '/balance',
    title: 'Check balance',
    description: 'We check Alice\'s balance. It\'s $120.00 — not $90.00, because the duplicate was idempotent.',
  ...
  },
  {
    ...
    method: 'POST',
    path: '/transactions',
    title: 'Debit -$999.99 (over limit)',
    description: 'We attempt to debit $999.99 — far more than Alice\'s $120.00.',
  ...
  },
  {
    ...
    description: 'We try to delete Alice\'s account while she still has $120.00.',
  ...
  },
  {
    ...
    path: '/transactions',
    title: 'Debit to zero',
    description: 'We debit Alice\'s remaining $120.00, bringing her balance to zero.',
